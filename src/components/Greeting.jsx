...
function Greeting() {
    ...
    return (<div style={{padding:".5em", borderRadius:"15px", display:"flex", flexDirection:"column", gap:".5em", flexWrap:"wrap", maxWidth:"95%"}}>
    ...
    {user.user.isBusiness && user.user.isAdmin && <>
        ...
        <p>Your Admin & Business Permissions allows you to view Sandbox/CRM Page, Create/Edit/Delete/Like Business Cards.</p>
            <div className="greeting-btns">
                ...
                <NavLink to="/business/add-business"> <button>Add Card</button> </NavLink>
                <NavLink to="/sandbox-crm"> <button>Sandbox CRM</button> </NavLink>
        </div>
    </>}
