...
function Greeting() {
    ...
    return (<div style={{border:"1px solid gold", padding:".5em", borderRadius:"15px", display:"flex", flexDirection:"column", gap:".5em"}}>
    ...
    {user.user.isBusiness && user.user.isAdmin && <>
        ...
        <div className="greeting-btns" style={{display:"flex", justifyContent:"center", alignItems:"center", gap:".3em"}}>
                ...
                <NavLink to="/business/add-business"> <button>Add Business Card</button> </NavLink>
                <NavLink to="/sandbox-crm"> <button>Sandbox CRM</button> </NavLink>
        </div>
    </>}
